...
class ASNSummary extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
    ...
    return (
      <Container>
        ...
        <div className={classes.poDetail} style={{ marginTop: '-1%' }}>
          <Typography>ASN SUMMARY</Typography>
          ...
          <Grid container>
            <Grid container item xs={12} spacing={1}>
              <Grid item xs={2} zeroMinWidth>
                <p className={classes.summeryPTag}>#ASN ID</p>
              ...
              <Grid item xs={2} zeroMinWidth>
                <p className={classes.summeryPTag}>SHIPPED QTY</p>
...
ASNSummary.propTypes = {
  classes: PropTypes.object.isRequired,
};
export default withStyles(styles)(ASNSummary);
